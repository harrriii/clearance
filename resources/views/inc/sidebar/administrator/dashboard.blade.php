        ...
        <div class="sidebar-sticky pt-3">
          ...
          <ul class="nav flex-column">
            ...
            <li class="nav-item py-0">
              ...
              <a class="nav-link text-secondary py-1 ml-1" style="font-size: 9pt;" href="/dashboard/department" id="nv_dashboard">
          ...
          <ul class="nav flex-column mb-2">
            ...
            <li class="nav-item py-0">
              ...
              <a class="nav-link text-secondary py-1 ml-1" style="font-size: 9pt;" href="/dashboard/report">
          ...
          <ul class="nav flex-column mb-2">
            ...
            <li class="nav-item py-0">
              ...
              <a class="nav-link text-secondary py-1 ml-1" style="font-size: 9pt;" href="/dashboard/excel/templates">
