...
@section('content')
  ...
  <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
      ...
      <h1 class="h2" style="font-size: 15pt">Clearance Control</h1>
          ...
          <table class="table table-striped">
            ...
            <thead>
              ...
              <tr>
                ...
                <th class="text-center py-2" style="font-size: 9pt !important;" >Campus</th>

                <th class="text-center py-2" style="font-size: 9pt !important;" >Start Date</th>

                <th class="text-center py-2" style="font-size: 9pt !important;" >End Date</th>

                <th class="text-center py-2" style="font-size: 9pt !important;" >Started By</th>
            ...
            <tbody>
              ...
              @foreach ($data as $d)
                ...
                <tr >
                  ...
                  <td style="font-size: 8pt !important;" class="text-center py-1">{{$d->campusName}}</td>

                  <td style="font-size: 8pt !important;" class="text-center py-1">{{$d->startDate}}</td>

                  <td style="font-size: 8pt !important;" class="text-center py-1">{{$d->endDate}}</td>
                  ...
                  <td class="text-center py-1">
                    ...
                    <a style="color:#7A353C;" campus={{$d->campus}} code={{$d->id}} startDate={{$d->startDate}} endDate={{$d->endDate}} startedBy={{$d->started}}  status={{$d->status}} class="a_icon __edit"><i data-feather="edit" class="icon"></i></a>
